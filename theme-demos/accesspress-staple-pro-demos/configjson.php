...
$git_url 		= 'https://raw.githubusercontent.com/WPaccesskeys/WPaccesskeys.github.io/master/theme-demos/accesspress-staple-pro-demos/';
$data = array(
	'default' => array(
		'demo_name' => 'default',
		...
		'import_redux'		=> array(
			...
			'option_name' 	=> 'accesspress_staple_pro',
		),
		'screen'			=> $git_url . 'default/default.png',
		'preview_url'		=> 'https://demo.accesspressthemes.com/accesspress-staple-pro/',
		'is_shop'			=> true,
		'menus' 			=> array(
			'primary' => 'Main Menu',
		),
...
/*
<?php
$settings = get_option( 'accesspress_staple_pro' );
