...
$git_url 		= 'https://raw.githubusercontent.com/WPaccesskeys/WPaccesskeys.github.io/master/theme-demos/the-launcher-pro-demos/';
$data = array(
	'video' => array(
		'demo_name' => 'Coming Soon: Video',
		'xml_file'     		=> $git_url . 'video/content.xml',
		'widgets_file'  	=> $git_url . 'video/widgets.wie',
		'theme_settings' 	=> $git_url . 'video/customizer.dat',
		'screen'			=> $git_url . 'video/screenshot.png',
		'preview_url'		=> 'http://demo.accesspressthemes.com/the-launcher-pro/coming-soon-video/',
		'home_title'	=> 'Home',
	...
	'color' => array(
		'demo_name' => 'Coming Soon: Color',
		'xml_file'     		=> $git_url . 'color/content.xml',
		'widgets_file'  	=> $git_url . 'color/widgets.wie',
		'theme_settings' 	=> $git_url . 'color/customizer.dat',
		'screen'			=> $git_url . 'color/screenshot.png',
		'preview_url'		=> 'http://demo.accesspressthemes.com/the-launcher-pro/coming-soon-color-bg/',
		'home_title'	=> 'Home',
		'required_plugins'  => array(
			'free' => array(
				array(
	...
	'slider' => array(
		'demo_name' => 'Coming Soon: Slider',
		'xml_file'     		=> $git_url . 'slider/content.xml',
		'widgets_file'  	=> $git_url . 'slider/widgets.wie',
		'theme_settings' 	=> $git_url . 'slider/customizer.dat',
		'screen'			=> $git_url . 'slider/screenshot.png',
		'preview_url'		=> 'http://demo.accesspressthemes.com/the-launcher-pro/coming-soon-slide/',
		'home_title'	=> 'Home',
		'required_plugins'  => array(
			'free' => array(
				array(
	...
	'landing' => array(
		'demo_name' => 'Coming Soon: Landing',
		'xml_file'     		=> $git_url . 'landing/content.xml',
		'widgets_file'  	=> $git_url . 'landing/widgets.wie',
		'theme_settings' 	=> $git_url . 'landing/customizer.dat',
		'screen'			=> $git_url . 'landing/screenshot.png',
		'preview_url'		=> 'http://demo.accesspressthemes.com/the-launcher-pro/landing-page/',
		'home_title'	=> 'Home',
		'required_plugins'  => array(
			'free' => array(
				array(
	...
	'multipurpose' => array(
		'demo_name' => 'Coming Soon: multipurpose',
		'xml_file'     		=> $git_url . 'multipurpose/content.xml',
		'widgets_file'  	=> $git_url . 'multipurpose/widgets.wie',
		'theme_settings' 	=> $git_url . 'multipurpose/customizer.dat',
		'screen'			=> $git_url . 'multipurpose/screenshot.png',
		'preview_url'		=> 'https://demo.accesspressthemes.com/the-launcher-pro/simple-home',
		'is_shop'			=> true,
		'home_title'	=> 'Home',
		'menus' 			=> array(
			'primary' => 'Primary',
	...
	'lite' => array(
		'demo_name' => 'Coming Soon: Lite',
		'xml_file'     		=> $git_url . 'lite/content.xml',
		'widgets_file'  	=> $git_url . 'lite/widgets.wie',
		'theme_settings' 	=> $git_url . 'lite/customizer.dat',
		'screen'			=> $git_url . 'lite/screenshot.png',
		'preview_url'		=> 'http://demo.accesspressthemes.com/the-launcher-pro/lite-demo/',
		'home_title'	=> 'Home',
		'required_plugins'  => array(
			'free' => array(
				array(
